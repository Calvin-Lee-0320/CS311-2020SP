...
class htable
{
 ...
 public:
  ...
  void displayTable(); // displays the table with slot#s
    ...
    void Findcourse(htable mytranscript);
    void Loadinfo(htable mytranscript);
    void addcourse(htable myT);
    void deletecourse(htable mytranscript);
    void saveInfo(htable mytranscript);
